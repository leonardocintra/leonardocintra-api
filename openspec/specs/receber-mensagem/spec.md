...
Definir os requisitos dos DTOs de validação do webhook de recebimento de mensagens do módulo WhatsApp, incluindo o envelope completo, metadados do evento, dados da mensagem, chave e conteúdo flexível da mensagem.
